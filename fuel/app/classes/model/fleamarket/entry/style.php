...
QUERY;
     ...
     * @author shimma
     *
     * @todo このmethod自体が不要か検討
     */
    public static function getFleamarketEntryStyle($fleamarket)
    {
        if (empty($fleamarket['fleamarket_id'])) {
            return false;
        }
        ...
        return self::findByFleamarketId($fleamarket['fleamarket_id'], $entry_style_fields);
    }
     ...
     * @author shimma
     */
    public static function getTotalBooth($fleamarket)
    {
        $total_booth = 0;
