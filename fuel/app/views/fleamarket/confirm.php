    ...
    <div class="box clearfix">
      ...
      <form class="form-horizontal" action="/fleamarket/thanks" method="post">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10"><?php echo e($fleamarket_input['promoter_name']);?></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputWebsite">主催者ホームページ</label>
          <div class="col-sm-10"><?php echo e($fleamarket_input['website']);?></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputReservationTel">予約受付電話番号</label>
          <div class="col-sm-10"><?php echo e($fleamarket_input['reservation_tel']);?></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputReservationEmail">予約受付<br>E-mailアドレス</label>
          <div class="col-sm-10"><?php echo e($fleamarket_input['reservation_email']);?></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputEventDate">開催日</label>
          <div class="col-sm-10"><?php echo e($fleamarket_input['event_date']);?></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputEventTimeStart">開始時間</label>
          <div class="col-sm-10"><?php echo e($fleamarket_input['event_time_start']);?></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputEventTimeEnd">終了時間</label>
          <div class="col-sm-10"><?php echo e($fleamarket_input['event_time_end']);?></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputName">フリマ名</label>
          <div class="col-sm-10"><?php echo e($fleamarket_input['name']);?></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputPlaceName">会場名</label>
          <div class="col-sm-10"><?php echo e($location_input['name']);?></div>
        </div>
        <div class="form-group form-address">
          <label class="col-sm-2 control-label" for="inputZip">ご住所</label>
          <div class="col-sm-10">
            <div>〒<?php echo e($location_input['zip']);?></div>
            <div><?php echo e($prefectures[$location_input['prefecture_id']] . $location_input['address']);?></div>
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputAboutAccess">最寄り駅または<br>交通アクセス</label>
          <div class="col-sm-10"><?php echo e($fleamarket_about_input['description']);?></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputDescription">内容<br>（出店方法、募集数、料金等）</label>
          <div class="col-sm-10"><?php echo e($fleamarket_input['description']);?></div>
        </div>
        <div id="submitButton" class="form-group">
          <a href="/fleamarket" class="btn btn-default">入力に戻る</a>
          <button id="do_register" type="submit" class="btn btn-default">内容を確認する</button>
        </div>
      </form>
    </div>
  </div>
