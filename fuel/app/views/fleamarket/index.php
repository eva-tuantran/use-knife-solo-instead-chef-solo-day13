    ...
    <div class="box clearfix">
      ...
      <form class="form-horizontal" action="/fleamarket/confirm/" method="post">
        ...
        <div class="form-group form-address">
          ...
          <div class="col-sm-10">
            <input id="inputZip" type="text" class="form-control" name="l[zip]" placeholder="例）1234567" value="<?php echo $location['zip'];?>"><button type="button" class="btn btn-default">住所を検索</button>
