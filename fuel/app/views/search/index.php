      ...
      <div class="box clearfix">
        ...
        ?>
          <fieldset>
            ...
            ?>
            <label><input type="checkbox" name="add_conditions[event_status][]" value="<?php echo \Model_Fleamarket::EVENT_STATUS_SCHEDULE;?>" <?php echo $is_checked ? 'checked': '';?>>開催予定</label>
            <?php
            ...
            ?>
            <label><input type="checkbox" name="add_conditions[event_status][]" value="<?php echo \Model_Fleamarket::EVENT_STATUS_RESERVATION_RECEIPT;?>" <?php echo $is_checked ? 'checked': '';?>>予約受付中</label>
            <?php
            ...
            ?>
            <label><input type="checkbox" name="add_conditions[event_status][]" value="<?php echo \Model_Fleamarket::EVENT_STATUS_RECEIPT_END;?>" <?php echo $is_checked ? 'checked': '';?>>受付終了</label>
            <?php
                $is_checked = isset($add_conditions['event_status']) && in_array(\Model_Fleamarket::EVENT_STATUS_CLOSE, $add_conditions['event_status']);
            ?>
            <label><input type="checkbox" name="add_conditions[event_status][]" value="<?php echo \Model_Fleamarket::EVENT_STATUS_CLOSE;?>" <?php echo $is_checked ? 'checked': '';?>>開催終了</label>
            <h3>出店形態</h3>
            <?php
            ...
            ?>
            <label><input type="checkbox" name="add_conditions[entry_style][]" value="<?php echo $entry_style_id;?>" <?php echo $is_checked ? 'checked': '';?>><?php echo e($entry_style_name);?></label>
            <?php
                endforeach;
            ?>
            <h3>出店料金</h3>
            ...
            ?>
            <label><input type="checkbox" name="add_conditions[shop_fee][]" value="<?php echo \Model_Fleamarket::SHOP_FEE_FLAG_FREE;?>" <?php echo $is_checked ? 'checked': '';?>>無料出店</label>
            <?php
                $is_checked = isset($add_conditions['shop_fee']) && in_array(\Model_Fleamarket::SHOP_FEE_FLAG_CHARGE, $add_conditions['shop_fee']);
            ?>
            <label><input type="checkbox" name="add_conditions[shop_fee][]" value="<?php echo \Model_Fleamarket::SHOP_FEE_FLAG_CHARGE;?>" <?php echo $is_checked ? 'checked': '';?>>有料出店</label>
            <div id="searchButton">
