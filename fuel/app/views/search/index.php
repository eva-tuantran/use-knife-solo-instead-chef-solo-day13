    ...
    <div class="col-md-2">
        <div class="find_box">
            ...
            <ul class="find_condtion">
                <li><?php
                    echo Form::checkbox('filter[event_status][]', FLEAMARKET_EVENT_SCHEDULE, null, array('id' => 'form_event_schedule'));
                    echo Form::label('開催予定', null, array('for' => 'form_event_schedule'));
                ?></li>
                <li><?php
                    echo Form::checkbox('filter[event_status][]', FLEAMARKET_EVENT_RESERVATION_RECEIPT, null, array('id' => 'form_event_reservation_receipt'));
                    echo Form::label('予約受付中', null, array('for' => 'form_event_reservation_receipt'));
                ?></li>
                <li><?php
                    echo Form::checkbox('filter[event_status][]', FLEAMARKET_EVENT_RECEIPT_END, null, array('id' => 'form_event_receipt_end'));
                    echo Form::label('受付終了', null, array('for' => 'form_event_receipt_end'));
                ?></li>
                <li><?php
                    echo Form::checkbox('filter[event_status][]', FLEAMARKET_EVENT_CLOSE, null, array('id' => 'form_event_close'));
        ...
        <div class="find_box">
            ...
            <ul class="find_condtion">
                ...
                ?>
                <li><?php
                    echo Form::checkbox('filter[entry_style][]', $entry_style_id, null, array('id' => $id));
        ...
        <div class="find_box">
            ...
            <ul class="find_condtion">
                <li><?php
                    echo Form::checkbox('filter[shop_fee_free]', FLEAMARKET_EVENT_CLOSE, null, array('id' => 'form_shop_fee_free'));
                    echo Form::label('無料出店', null, array('for' => 'form_shop_fee_free'));
                ?></li>
                <li><?php
                    echo Form::checkbox('filter[shop_fee_charge]', FLEAMARKET_EVENT_RECEIPT_END, null, array('id' => 'form_shop_fee_charge'));
