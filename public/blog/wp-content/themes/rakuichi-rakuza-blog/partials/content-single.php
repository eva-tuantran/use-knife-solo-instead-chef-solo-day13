...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="page-header">
		...
		<div class="entry-meta post_meta_box">
		<?php the_bootstrap_posted_on(); ?>
		<span class="post_man"><a href="<?php echo esc_url( replace_special_link(get_author_posts_url( get_the_author_meta("ID"))) ); ?>"><?php echo get_avatar(get_the_author_meta("ID"),30); ?><span><?php the_author(); ?></span></a></span>
		</div><!-- .entry-meta -->
	</header><!-- .entry-header -->
